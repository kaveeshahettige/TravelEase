...
<main>
    ...
    <div class="table-content">
        <div class="tab">
            ...
            <a href="<?php echo URLROOT?>/hotel/rejbookings"><button class="tablinks active">Cancelled Bookings</button></a>
        </div>
    </div>
    ...
    <div class="table-content">
        <h2>Cancelled Booking Details</h2>
                    <?php if (empty($data["cancelledbBokings"])): ?>
        ...
        <table class="booking-table">
            ...
            <?php
            $cancelledbBokings = $data["cancelledbBokings"];
            //                var_dump($bookingData[6]);
            foreach ($cancelledbBokings as $key => $cancellbooking):
