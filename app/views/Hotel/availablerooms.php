...
<!--                        <td>--><?php //echo ucfirst($hotel_rooms->price); ?><!--</td>-->
<!--                        <td>--><?php //echo ucfirst($hotel_rooms->roomDescription); ?><!--</td>-->
                        <td><?php echo ($hotel_rooms->roomAvailability == 0) ? 'Available' : 'Unavailable'; ?></td>
                        <td>
                            <button class="btn btn-make-unavailable" onclick="makeUnavailable(<?php echo $hotel_rooms->roomId; ?>)">
                                <i class='bx bx-check'></i>
                            </button>

                            <button class="btn btn-delete-unavailable" onclick="makeAvailable(<?php echo $hotel_rooms->roomId; ?>)">
