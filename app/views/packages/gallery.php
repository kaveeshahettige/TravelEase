...
<<<<<<< Updated upstream
    <link rel="stylesheet" href="css/Packages-gallery.css">
    <title>Dashboard</title>
    <link rel="icon" type="image/x-icon" href="./Images/TravelEase.png">
=======
    <link rel="stylesheet" href="<?php echo URLROOT;?>css/packages/Packages-gallery.css">
    <title>Gallery</title>
...
<<<<<<< Updated upstream
            <img src="Gallery images/Uththara.jpg" alt="Profile Photo">
...
<<<<<<< Updated upstream
        ...
        <ul>
            <li><a href="Packages-dashboard.html"><i class='bx bxs-dashboard bx-sm'></i> Dashboard</a></li>
            <li><a href="../Availability/Packages-availability.html"><i class='bx bxs-calendar bx-sm bx-fw'></i> Availability</a></li>
            <li><a href="../Bookings/Packages-bookings.html"><i class='bx bxs-book bx-sm bx-fw'></i> Bookings</a></li>
            <li><a href="../Gallery/Packages-gallery.html" class="active"><i class='bx bx-images bx-sm bx-fw'></i> Gallery</a></li>
            <li><a href="../Revenue/Packages-revenue.html"><i class= 'bx bxs-wallet bx-sm bx-fw'></i> Revenue</a></li>
            <li><a href="../Packages/Packages.html"><i class='bx bxs-package bx-sm'></i> Packages</a></li>
            <li><a href="../Review/Packages-review.html"><i class='bx bxs-star bx-sm bx-fw'></i> Review</a></li>
            <li><a href="../Settings/Packages-settings.html"><i class='bx bxs-cog bx-sm'></i>Settings</a></li>
=======
        ...
        <ul>
            ...
            <li><a href="<?php echo URLROOT;?>packages/gallery" class="nav-button active"><i class='bx bx-images bx-sm bx-fw'></i> Gallery</a></li>
...
<<<<<<< Updated upstream
            <img src="Gallery images/TravelEase.png" alt="TravelEase Logo">
